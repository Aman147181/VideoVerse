  ...
  return (
    <div className="flex h-[80px] items-center justify-center space-x-3 md:space-x-6 lg:space-x-10 px-4">
      ...
      <input
        ...
        className="2xl:w-5/12  xl:w-1/2 lg:w-8/12 md:w-8/12 sm:flex-col sm:w-1/3 w-40 p-4 bg-slate-50 text-xl text-slate-600 rounded-3xl shadow-md focus:shadow-2xl focus:outline-none border-slate-400 placeholder:text-xl"
        placeholder="search videos... "
        onSubmit={()=>{setSearchTerm(typed)}}
      ></input>
      <button
